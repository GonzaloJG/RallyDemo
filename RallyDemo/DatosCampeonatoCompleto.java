...
public class DatosCampeonatoCompleto
{
    ...
    public void initData(){
        ...
        Organizacion org = Organizacion.getInstance(Collections.reverseOrder(new ComparadorDistancia()));
        ...
        peugeot.setComparadorPilotos(new ComparadorTotalPuntosDos());
        peugeot.setComparadorCoches(new ComparadorCocheCombustible());
        peugeot.inscribirme();
        ...
        citroen.setComparadorPilotos(Collections.reverseOrder(new ComparadorTotalPuntosDos()));
        citroen.setComparadorCoches(Collections.reverseOrder(new ComparadorCocheCombustible()));
        citroen.inscribirme();
        ...
        seat.setComparadorPilotos(new ComparadorTotalPuntosDos());
        seat.setComparadorCoches(new ComparadorCocheCombustible());
        seat.inscribirme();
